...
const BUNDLE_JS='./__pmk-app-v82-1.js';
const BUNDLE_CSS='./__pmk-styles-v82-1.css';
...
./test-v82-ui-swipe-v1.js?v=82-1
./floating-note-mobile-v82-1.js?v=82-1
./version-guard-v82-1.js?v=82-1
./keep-worker-v82-1.js?v=82-1
`.trim().split(/\s+/);

const CSS=`
./styles.css?source=82-1
...
./test-v82-ui-swipe-v1.css?v=82-1
./floating-note-mobile-v82-1.css?v=82-1
`.trim().split(/\s+/);
...
async function textAsset(url){
  ...
  if(url.includes('version-guard-v82-1.js')&&!text.includes("const VERSION = '82.1'"))throw new Error('Неверный контрольный файл v82.1');
  if(url.includes('test-v82-ui-swipe-v1.js')&&!text.includes('PMK_V82_UI_SWIPE_TEST_V1'))throw new Error('Не найдено исправление свайпов v82.1');
  if(url.includes('floating-note-mobile-v82-1.js')&&!text.includes('PMK_FLOATING_NOTE_MOBILE_V82_1'))throw new Error('Не найдено исправление заметки v82.1');
  return text;
}
