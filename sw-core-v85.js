...
const BUNDLE_JS='./__pmk-app-v85.js';
const BUNDLE_CSS='./__pmk-styles-v85.css';
...
./settings-version-header-v59.js?v=85
...
./status-ledger-v80.js?v=85
./in-work-workflow-v73.js?v=73
./status-pipeline-v81.js?v=85
./archive-policy-v82.js?v=85
./completed-archive-workflow-v82.js?v=85
./period-model-v83.js?v=85
./mobile-period-workday-v83.js?v=85
./period-class-fix-v83.js?v=85
./period-header-provider-v85.js?v=85
./version-guard-v85.js?v=85
`.trim().split(/\s+/);

const CSS=`
./styles.css?source=85
...
./instant-status-feedback-v77.css?v=85
./completed-archive-workflow-v82.css?v=85
./mobile-period-workday-v83.css?v=85
./period-class-fix-v83.css?v=85
./period-header-provider-v85.css?v=85
`.trim().split(/\s+/);
...
async function textAsset(url){
  ...
  if(url.includes('version-guard-v85.js')&&!text.includes("const VERSION = '85'"))throw new Error('Неверный контрольный файл v85');
  return text;
}
