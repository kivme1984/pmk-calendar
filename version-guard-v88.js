...
(() => {
  ...
  function applyVersion() {
    ...
    panel.querySelector('#settingsVersionValue').textContent = 'v88';
    panel.querySelector('#settingsVersionRelease').textContent = 'Статусы вертикально 4×1 · 2026-07-01';
    panel.querySelector('#settingsUpdateButton').href = './reset.html?v=88-settings';
    return true;
  }
