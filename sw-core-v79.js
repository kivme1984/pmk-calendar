...
const BUNDLE_JS='./__pmk-app-v79.js';
const BUNDLE_CSS='./__pmk-styles-v79.css';

const JS=[
  './app.js?source=79','./manager-planner-core.js','./manager-planner-hooks.js',
  ...
  './workshop-measurement-v58.js?v=58','./settings-version-header-v59.js?v=79',
...
const CSS=[
  './styles.css?source=79','./manager-planner.css?v=32','./address-autocomplete.css?v=39',
  ...
  './instant-status-feedback-v77.css?v=77','./completed-workflow-v79.css?v=79'
];
...
async function textAsset(url,required=false){
  try{
    ...
    if(required&&url.includes('version-guard-v79.js')&&!text.includes("const VERSION = '79'"))throw new Error('Неверный контрольный файл версии');
    return text;
  }catch(error){
