// PMK Calendar v82.20.0 - cardfix26 unique standalone service worker
const VERSION='82.20.0';
const BUILD='cardfix26-address-single-label-icon-center';
...
async function textAsset(url){
  ...
  if(url.includes('form-placeholders-address-strict-v82-20-25.js')&&!text.includes('PMK_FORM_PLACEHOLDERS_ADDRESS_STRICT_V82_20_26'))throw new Error('Не получен финальный фикс адреса и лупы');
