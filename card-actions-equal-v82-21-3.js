...
(() => {
  if (globalThis.PMK_CARD_ACTIONS_EQUAL_V82_21_3) return;
  globalThis.PMK_CARD_ACTIONS_EQUAL_V82_21_3 = true;

  function inject() {
    document.getElementById('pmkCardActionsEqualV8213')?.remove();
    const style = document.createElement('style');
    style.id = 'pmkCardActionsEqualV8213';
    style.textContent = `
  ...
  function applyClass() {
    document.querySelectorAll('.event-card .event-actions .manage-row').forEach(row => row.classList.add('pmk-card-actions-equal-v82-21-3'));
  }
