...
const BUNDLE_JS='./__pmk-app-v84.js';
const BUNDLE_CSS='./__pmk-styles-v84.css';
...
./settings-version-header-v59.js?v=84
...
./status-ledger-v80.js?v=84
./in-work-workflow-v73.js?v=73
./status-pipeline-v81.js?v=84
./archive-policy-v82.js?v=84
./completed-archive-workflow-v82.js?v=84
./period-model-v83.js?v=84
./mobile-period-workday-v83.js?v=84
./period-class-fix-v83.js?v=84
./mobile-period-hotfix-v84.js?v=84
./version-guard-v84.js?v=84
`.trim().split(/\s+/);

const CSS=`
./styles.css?source=84
...
./instant-status-feedback-v77.css?v=84
./completed-archive-workflow-v82.css?v=84
./mobile-period-workday-v83.css?v=84
./period-class-fix-v83.css?v=84
./mobile-period-hotfix-v84.css?v=84
`.trim().split(/\s+/);
...
async function textAsset(url){
  ...
  if(url.includes('version-guard-v84.js')&&!text.includes("const VERSION = '84'"))throw new Error('Неверный контрольный файл v84');
  return text;
}
