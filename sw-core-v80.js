...
const BUNDLE_JS='./__pmk-app-v80.js';
const BUNDLE_CSS='./__pmk-styles-v80.css';

const JS=[
  './app.js?source=80','./manager-planner-core.js','./manager-planner-hooks.js',
  ...
  './workshop-measurement-v58.js?v=58','./settings-version-header-v59.js?v=80',
  ...
  './compact-floating-note-v73.js?v=74','./status-ledger-v80.js?v=80',
  './in-work-workflow-v73.js?v=73','./status-pipeline-v80.js?v=80',
  './completed-workflow-v80.js?v=80','./version-guard-v80.js?v=80'
];

const CSS=[
  './styles.css?source=80','./manager-planner.css?v=32','./address-autocomplete.css?v=39',
  ...
  './instant-status-feedback-v77.css?v=77','./completed-workflow-v80.css?v=80'
];
...
const REQUIRED_JS=new Set([
  ...
  './status-ledger-v80.js?v=80','./in-work-workflow-v73.js?v=73',
  './status-pipeline-v80.js?v=80','./completed-workflow-v80.js?v=80','./version-guard-v80.js?v=80'
]);
...
async function textAsset(url,required=false){
  try{
    ...
    if(required&&url.includes('version-guard-v80.js')&&!text.includes("const VERSION = '80'"))throw new Error('Неверный контрольный файл версии');
    return text;
  }catch(error){
