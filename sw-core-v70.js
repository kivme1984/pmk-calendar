...
const BUNDLE_JS='./__pmk-app-v70.js';
const BUNDLE_CSS='./__pmk-styles-v70.css';

const JS=[
  './app.js?source=70','./manager-planner-core.js','./manager-planner-hooks.js',
...
const CSS=[
  './styles.css?source=70','./manager-planner.css?v=32','./address-autocomplete.css?v=39',
