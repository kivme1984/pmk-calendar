...
(() => {
  ...
  function applyVersion() {
    ...
    panel.querySelector('#settingsVersionValue').textContent = 'v80';
    panel.querySelector('#settingsVersionRelease').textContent = 'Проверенная сборка · 2026-06-30';
    panel.querySelector('#settingsUpdateButton').href = './reset.html?v=80-settings';
    return true;
  }
  ...
  function install() {
    ...
    window.dispatchEvent(new CustomEvent('pmk-version-ready', { detail:{ version:'80' } }));
  }
