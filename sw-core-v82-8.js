...
const BUNDLE_JS='./__pmk-app-v82-8.js';
const BUNDLE_CSS='./__pmk-styles-v82-8.css';
...
./settings-version-header-v59.js?v=82
...
./compact-floating-note-v73.js?v=74
./status-ledger-v80.js?v=82
./in-work-workflow-v73.js?v=73
./status-pipeline-v81.js?v=82
./archive-policy-v82.js?v=82
./completed-archive-workflow-v82.js?v=82
./floating-note-mobile-v82-1.js?v=82-8
./status-left-column-v82-2.js?v=82-8
./workflow-fast-v82-7.js?v=82-8
./workflow-transition-fast-v82-7.js?v=82-8
./version-guard-v82-8.js?v=82-8
./keep-worker-v82-8.js?v=82-8
`.trim().split(/\s+/);

const CSS=`
./styles.css?source=82-8
...
./compact-floating-note-v73.css?v=74
./in-work-workflow-v73.css?v=73
./light-interface-v74.css?v=74
./contract-required-v75.css?v=75
./instant-status-feedback-v77.css?v=82
./completed-archive-workflow-v82.css?v=82
./floating-note-mobile-v82-1.css?v=82-8
./status-left-column-v82-2.css?v=82-8
./workflow-fast-v82-7.css?v=82-8
./workflow-transition-fast-v82-7.css?v=82-8
`.trim().split(/\s+/);

const OPTIONAL=['./reset.html','./recovery.html','./safe.html','./install-v82-8.html','./test-v82-7.html','./manifest.webmanifest','./version.json','./icons/icon-192.png','./icons/icon-512.png'];

function fetchWithTimeout(url,timeout=18000){
...
async function textAsset(url){
  ...
  if(url.includes('version-guard-v82-8.js')&&!text.includes("const VERSION = '82.8'"))throw new Error('Неверный контрольный файл v82.8');
  if(url.includes('floating-note-mobile-v82-1.js')&&!text.includes('PMK_FLOATING_NOTE_MOBILE_V82_1'))throw new Error('Не найдено исправление заметки v82.8');
  if(url.includes('status-left-column-v82-2.js')&&!text.includes('PMK_STATUS_LEFT_COLUMN_V82_2'))throw new Error('Не найдено исправление вертикальных статусов v82.8');
  if(url.includes('workflow-fast-v82-7.js')&&!text.includes('PMK_WORKFLOW_FAST_V82_7'))throw new Error('Не найден полный интерфейс этапов v82.8');
  if(url.includes('workflow-transition-fast-v82-7.js')&&!text.includes('PMK_WORKFLOW_TRANSITION_FAST_V82_7'))throw new Error('Не найден быстрый переход статусов v82.8');
  return text;
}
