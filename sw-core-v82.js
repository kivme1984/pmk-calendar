...
const BUNDLE_JS='./__pmk-app-v82-31-0.js';
const BUNDLE_CSS='./__pmk-styles-v82-31-0.css';
...
async function textAsset(url){
  ...
  if(url.includes('month-summary-v82-28.js')&&!text.includes('PMK_MONTH_DIRECT_RENDER_V82_31'))throw new Error('Не получен прямой месячный рендер v82.31.0');
