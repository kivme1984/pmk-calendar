...
const BUNDLE_JS='./__pmk-app-v82.js';
const BUNDLE_CSS='./__pmk-styles-v82.css';
...
./version-guard-v82.js?v=82
`.trim().split(/\s+/);

const CSS=`
./styles.css?source=82
...
async function textAsset(url){
  ...
  if(url.includes('version-guard-v82.js')&&!text.includes("const VERSION = '82'"))throw new Error('Неверный контрольный файл v82');
  return text;
}
