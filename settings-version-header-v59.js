...
(() => {
  ...
  async function install() {
    ...
    panel.innerHTML = '<div class="settings-version-info"><span class="settings-version-label">Версия приложения</span><strong id="settingsVersionValue">v88</strong><small id="settingsVersionRelease">Статусы вертикально 4×1 · 2026-07-01</small></div><a id="settingsUpdateButton" class="button button-primary settings-update-button" href="./reset.html?v=88-settings">Обновить приложение</a>';
