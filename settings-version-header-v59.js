...
(() => {
  ...
  async function loadVersion() {
    try {
      ...
      return { version:'68', release:'full-function-performance-parser-fix', date:'2026-06-30' };
    }
  }
  ...
  async function install() {
    ...
    panel.innerHTML = '<div class="settings-version-info"><span class="settings-version-label">Версия приложения</span><strong id="settingsVersionValue">v68</strong><small id="settingsVersionRelease">Основная версия</small></div><a id="settingsUpdateButton" class="button button-primary settings-update-button" href="./reset.html?v=68-settings">Обновить приложение</a>';
    heading.insertAdjacentElement('afterend', panel);
    const info = await loadVersion();
    const version = String(info?.version || '68');
