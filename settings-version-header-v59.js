...
(() => {
  ...
  async function install() {
    ...
    panel.innerHTML = '<div class="settings-version-info"><span class="settings-version-label">Версия приложения</span><strong id="settingsVersionValue">v79</strong><small id="settingsVersionRelease">Проверенная сборка · 2026-06-30</small></div><a id="settingsUpdateButton" class="button button-primary settings-update-button" href="./reset.html?v=79-settings">Обновить приложение</a>';
