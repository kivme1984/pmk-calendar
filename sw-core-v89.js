...
const BUNDLE_JS='./__pmk-app-v89.js';
const BUNDLE_CSS='./__pmk-styles-v89.css';
...
./settings-version-header-v59.js?v=89
...
./compact-floating-note-v73.js?v=89
./status-ledger-v80.js?v=89
./in-work-workflow-v73.js?v=73
./status-pipeline-v81.js?v=89
./archive-policy-v82.js?v=89
./completed-archive-workflow-v82.js?v=89
./period-model-v83.js?v=89
./mobile-period-workday-v83.js?v=89
./period-class-fix-v83.js?v=89
./period-header-provider-v85.js?v=89
./mobile-workflow-fixes-v86.js?v=89
./workday-period-note-v86.js?v=89
./mobile-workflow-fixes-v89.js?v=89
./version-guard-v89.js?v=89
`.trim().split(/\s+/);

const CSS=`
./styles.css?source=89
...
./compact-floating-note-v73.css?v=89
./in-work-workflow-v73.css?v=73
./light-interface-v74.css?v=74
./contract-required-v75.css?v=75
./instant-status-feedback-v77.css?v=89
./completed-archive-workflow-v82.css?v=89
./mobile-period-workday-v83.css?v=89
./period-class-fix-v83.css?v=89
./period-header-provider-v85.css?v=89
./mobile-workflow-fixes-v86.css?v=89
./workday-period-note-v86.css?v=89
./mobile-workflow-fixes-v89.css?v=89
`.trim().split(/\s+/);
...
async function textAsset(url){
  ...
  if(url.includes('version-guard-v89.js')&&!text.includes("const VERSION = '89'"))throw new Error('Неверный контрольный файл v89');
  if(url.includes('mobile-workflow-fixes-v89.js')&&!text.includes('PMK_MOBILE_WORKFLOW_FIXES_V89'))throw new Error('Исправления v89 не загружены');
  return text;
}
...
self.addEventListener('install',event=>event.waitUntil((async()=>{
  ...
  await Promise.allSettled(OPTIONAL.map(async url=>{
    const response=await fetchWithTimeout(`${url}?install=${VERSION}`,6000);
