...
const BUNDLE_JS='./__pmk-app-v72.js';
const BUNDLE_CSS='./__pmk-styles-v72.css';

const JS=[
  './app.js?source=72','./manager-planner-core.js','./manager-planner-hooks.js',
  ...
  './settings-version-header-v59.js?v=72','./navigation-layer-swipe-fix-v60.js?v=60',
...
const CSS=[
  './styles.css?source=72','./manager-planner.css?v=32','./address-autocomplete.css?v=39',
  ...
  './provider-status-manager-v70.css?v=70','./floating-manager-note-v72.css?v=72'
];
