...
const BUNDLE_JS='./__pmk-app-v71.js';
const BUNDLE_CSS='./__pmk-styles-v71.css';

const JS=[
  './app.js?source=71','./manager-planner-core.js','./manager-planner-hooks.js',
  ...
  './settings-version-header-v59.js?v=71','./navigation-layer-swipe-fix-v60.js?v=60',
...
const CSS=[
  './styles.css?source=71','./manager-planner.css?v=32','./address-autocomplete.css?v=39',
