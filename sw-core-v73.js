...
const BUNDLE_JS='./__pmk-app-v73.js';
const BUNDLE_CSS='./__pmk-styles-v73.css';

const JS=[
  './app.js?source=73','./manager-planner-core.js','./manager-planner-hooks.js',
  ...
  './settings-version-header-v59.js?v=73','./navigation-layer-swipe-fix-v60.js?v=60',
  ...
  './yandex-primary-refresh-v72.js?v=72','./compact-floating-note-v73.js?v=73',
  './in-work-workflow-v73.js?v=73'
];

const CSS=[
  './styles.css?source=73','./manager-planner.css?v=32','./address-autocomplete.css?v=39',
  ...
  './manager-workspace-v66.css?v=67','./performance-fixes-v68.css?v=68',
  './provider-status-manager-v70.css?v=70','./compact-floating-note-v73.css?v=73',
...
const REQUIRED_CSS=new Set([
  ...
  './provider-status-manager-v70.css?v=70','./compact-floating-note-v73.css?v=73','./in-work-workflow-v73.css?v=73'
]);
...
self.addEventListener('install',event=>event.waitUntil((async()=>{
  ...
  await cacheResponse(cache,BUNDLE_JS,new Response(jsParts.join('\n\n'),{headers:{
    'Content-Type':'application/javascript; charset=utf-8','Cache-Control':'no-store','X-PMK-Version':VERSION
  }}));
  await cacheResponse(cache,BUNDLE_CSS,new Response(cssParts.join('\n\n'),{headers:{
    'Content-Type':'text/css; charset=utf-8','Cache-Control':'no-store','X-PMK-Version':VERSION
  }}));
