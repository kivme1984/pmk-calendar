...
(() => {
  ...
  function applyVersion() {
    ...
    panel.querySelector('#settingsVersionValue').textContent = 'v81';
    panel.querySelector('#settingsVersionRelease').textContent = 'Проверенная быстрая сборка · 2026-07-01';
    panel.querySelector('#settingsUpdateButton').href = './reset.html?v=81-settings';
    return true;
  }
  ...
  function install() {
    ...
    window.dispatchEvent(new CustomEvent('pmk-version-ready', { detail:{ version:'81' } }));
  }
