...
const BUNDLE_JS='./__pmk-app-v86.js';
const BUNDLE_CSS='./__pmk-styles-v86.css';
...
./settings-version-header-v59.js?v=86
...
./status-ledger-v80.js?v=86
./in-work-workflow-v73.js?v=73
./status-pipeline-v81.js?v=86
./archive-policy-v82.js?v=86
./completed-archive-workflow-v82.js?v=86
./period-model-v83.js?v=86
./mobile-period-workday-v83.js?v=86
./period-class-fix-v83.js?v=86
./period-header-provider-v85.js?v=86
./mobile-workflow-fixes-v86.js?v=86
./version-guard-v86.js?v=86
`.trim().split(/\s+/);

const CSS=`
./styles.css?source=86
...
./instant-status-feedback-v77.css?v=86
./completed-archive-workflow-v82.css?v=86
./mobile-period-workday-v83.css?v=86
./period-class-fix-v83.css?v=86
./period-header-provider-v85.css?v=86
./mobile-workflow-fixes-v86.css?v=86
`.trim().split(/\s+/);
...
async function textAsset(url){
  ...
  if(url.includes('version-guard-v86.js')&&!text.includes("const VERSION = '86'"))throw new Error('Неверный контрольный файл v86');
  return text;
}
