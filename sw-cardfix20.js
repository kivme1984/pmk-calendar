// PMK Calendar v82.20.0 - cardfix23 address search clean standalone service worker
const VERSION='82.20.0';
const BUILD='cardfix23-address-search-clean';
...
async function textAsset(url){
  ...
  if(url.includes('address-search-clean-v82-20-23.js')&&!text.includes('PMK_ADDRESS_SEARCH_CLEAN_V82_20_23'))throw new Error('Не получен чистый адресный блок');
