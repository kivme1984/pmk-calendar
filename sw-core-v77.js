...
const BUNDLE_JS='./__pmk-app-v77.js';
const BUNDLE_CSS='./__pmk-styles-v77.css';

const JS=[
  './app.js?source=77','./manager-planner-core.js','./manager-planner-hooks.js',
  ...
  './workshop-measurement-v58.js?v=58','./settings-version-header-v59.js?v=77',
  ...
  './status-work-immediate-v74.js?v=77'
];

const CSS=[
  './styles.css?source=77','./manager-planner.css?v=32','./address-autocomplete.css?v=39',
