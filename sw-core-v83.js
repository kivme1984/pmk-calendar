...
const BUNDLE_JS='./__pmk-app-v83.js';
const BUNDLE_CSS='./__pmk-styles-v83.css';
...
./settings-version-header-v59.js?v=83
...
./status-ledger-v80.js?v=83
./in-work-workflow-v73.js?v=73
./status-pipeline-v81.js?v=83
./archive-policy-v82.js?v=83
...
async function textAsset(url){
  ...
  if(url.includes('version-guard-v83.js')&&!text.includes("const VERSION = '83'"))throw new Error('Неверный контрольный файл v83');
  return text;
}
