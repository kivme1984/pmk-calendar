...
const BUNDLE_JS='./__pmk-app-v82-2.js';
const BUNDLE_CSS='./__pmk-styles-v82-2.css';
...
./test-v82-ui-swipe-v1.js?v=82-2
./floating-note-mobile-v82-1.js?v=82-2
./status-left-column-v82-2.js?v=82-2
./version-guard-v82-2.js?v=82-2
./keep-worker-v82-2.js?v=82-2
`.trim().split(/\s+/);

const CSS=`
./styles.css?source=82-2
...
./test-v82-ui-swipe-v1.css?v=82-2
./floating-note-mobile-v82-1.css?v=82-2
./status-left-column-v82-2.css?v=82-2
`.trim().split(/\s+/);

const OPTIONAL=['./reset.html','./recovery.html','./safe.html','./install-v82-2.html','./manifest.webmanifest','./version.json','./icons/icon-192.png','./icons/icon-512.png'];
...
async function textAsset(url){
  ...
  if(url.includes('version-guard-v82-2.js')&&!text.includes("const VERSION = '82.2'"))throw new Error('Неверный контрольный файл v82.2');
  if(url.includes('test-v82-ui-swipe-v1.js')&&!text.includes('PMK_V82_UI_SWIPE_TEST_V1'))throw new Error('Не найдено исправление шапки и свайпов v82.2');
  if(url.includes('floating-note-mobile-v82-1.js')&&!text.includes('PMK_FLOATING_NOTE_MOBILE_V82_1'))throw new Error('Не найдено исправление заметки v82.2');
  if(url.includes('status-left-column-v82-2.js')&&!text.includes('PMK_STATUS_LEFT_COLUMN_V82_2'))throw new Error('Не найдено исправление вертикальных статусов v82.2');
  return text;
}
