const VERSION='82.48.2';
const CACHE=`pmk-calendar-v${VERSION}`;
const BUNDLE_JS='./__pmk-app-v82-48-2.js';
const BUNDLE_CSS='./__pmk-styles-v82-48-2.css';
...
async function textAsset(url){
  ...
  if(url.includes('google-worker-final-v82-48-2.js')&&!text.includes('PMK_GOOGLE_WORKER_FINAL_V82_48_2'))throw new Error('missing final google module');
  return text;
}
