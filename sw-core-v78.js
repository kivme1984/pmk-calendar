...
const BUNDLE_JS='./__pmk-app-v78.js';
const BUNDLE_CSS='./__pmk-styles-v78.css';

const JS=[
  './app.js?source=78','./manager-planner-core.js','./manager-planner-hooks.js',
  ...
  './workshop-measurement-v58.js?v=58','./settings-version-header-v59.js?v=78',
  ...
  './status-work-immediate-v74.js?v=77','./version-guard-v78.js?v=78'
];

const CSS=[
  './styles.css?source=78','./manager-planner.css?v=32','./address-autocomplete.css?v=39',
  ...
  './instant-status-feedback-v77.css?v=77'
];
...
async function textAsset(url,required=false){
  try{
    ...
    if(required&&url.includes('version-guard-v78.js')&&!text.includes("const VERSION = '78'"))throw new Error('Неверный контрольный файл версии');
    return text;
  }catch(error){
