...
(() => {
  ...
  function applyVersion() {
    ...
    panel.querySelector('#settingsVersionValue').textContent = 'v83';
    panel.querySelector('#settingsVersionRelease').textContent = 'Мобильные периоды и рабочий день · 2026-07-01';
    panel.querySelector('#settingsUpdateButton').href = './reset.html?v=83-settings';
    return true;
  }
  ...
  function install() {
    ...
    window.dispatchEvent(new CustomEvent('pmk-version-ready', { detail:{ version:'83' } }));
  }
