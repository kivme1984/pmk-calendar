...
(() => {
  ...
  function applyVersion() {
    ...
    panel.querySelector('#settingsVersionValue').textContent = 'v89';
    panel.querySelector('#settingsVersionRelease').textContent = 'Кнопки 4×1 · свайпы 3 дня/неделя · полная синхронизация Google · 2026-07-01';
    panel.querySelector('#settingsUpdateButton').href = './reset.html?v=89-settings';
    return true;
  }
