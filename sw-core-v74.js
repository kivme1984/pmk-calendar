...
const BUNDLE_JS='./__pmk-app-v74.js';
const BUNDLE_CSS='./__pmk-styles-v74.css';

const JS=[
  './app.js?source=74','./manager-planner-core.js','./manager-planner-hooks.js',
  ...
  './workshop-measurement-v58.js?v=58','./settings-version-header-v59.js?v=74',
  ...
  './status-work-immediate-v74.js?v=74'
];

const CSS=[
  './styles.css?source=74','./manager-planner.css?v=32','./address-autocomplete.css?v=39',
...
const REQUIRED_JS=new Set([
  ...
  './in-work-workflow-v73.js?v=73','./status-work-immediate-v74.js?v=74'
]);
