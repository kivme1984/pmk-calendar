...
const JS=[
  './app.js?v=59','./manager-planner-core.js','./manager-planner-hooks.js',
  ...
  './settings-version-header-v59.js?v=59'
];
const CSS=[
  './styles.css?v=59','./manager-planner.css?v=32','./address-autocomplete.css?v=39',
  ...
  if(url.pathname.endsWith('/app.js')){
    event.respondWith((async()=>{
      try{
        ...
        console.error('PMK v59 bundle error',error);
        return fallback(event.request,'./app.js?v=59');
      }
    })());
    return;
  }
  ...
  if(url.pathname.endsWith('/styles.css')){
    event.respondWith((async()=>{
      try{
        ...
        console.error('PMK v59 styles error',error);
        return fallback(event.request,'./styles.css?v=59');
      }
    })());
    return;
  }
