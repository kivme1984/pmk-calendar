...
const JS=[
  './app.js?v=54','./manager-planner-core.js','./manager-planner-hooks.js',
  ...
  './pricing-settings-v67.js?v=69','./manager-ui-v50-preview.js?v=68',
  ...
  './android-autofill-off-v53.js?v=53','./preview-description-v53.js?v=54'
];
const CSS=[
  './styles.css?v=54','./manager-planner.css?v=32','./address-autocomplete.css?v=39',
  ...
  if(url.pathname.endsWith('/app.js')){
    event.respondWith((async()=>{
      try{
        ...
        console.error('PMK v54 bundle error',error);
        return fallback(event.request,'./app.js?v=54');
      }
    })());
    return;
  }
  ...
  if(url.pathname.endsWith('/styles.css')){
    event.respondWith((async()=>{
      try{
        ...
        console.error('PMK v54 styles error',error);
        return fallback(event.request,'./styles.css?v=54');
      }
    })());
    return;
  }
